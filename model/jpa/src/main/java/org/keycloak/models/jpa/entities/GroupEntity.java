...
@NamedQueries({
        ...
        @NamedQuery(name="getGroupIdsByNameInGroups", query="select u.id from GroupEntity u where u.realm.id = :realm and u.name like concat('%',:search,'%') and u.id in (:ids) order by u.name ASC"),
