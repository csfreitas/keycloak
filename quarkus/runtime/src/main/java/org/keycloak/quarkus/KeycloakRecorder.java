...
public class KeycloakRecorder {
    ...
    public void setBuildTimeProperties(Map<String, String> buildTimeProperties) {
        ...
        return new Profile(new Profile.PropertyResolver() {
            ...
            public String resolve(String feature) {
                if (feature.startsWith("keycloak.profile.feature")) {
                    feature = feature.replaceAll("keycloak\\.profile\\.feature", "kc\\.feature");    
                } else {
                    feature = "kc.feature";
                }
                ...
                if (value == null) {
                    value = getBuiltTimeProperty(feature.replaceAll("\\.feature\\.", "\\.feature-"));
                }
