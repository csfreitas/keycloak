...
@Command(name = "keycloak", 
        ...
        footer = "%nby Red Hat", 
        parameterListHeading = "Additional Options%n%n", 
        optionListHeading = "%nConfiguration Options%n%n", 
        commandListHeading = "%nCommands%n%n", 
        version = {
        "Keycloak ${sys:keycloak.version}",
...
public class MainCommand {
    ...
    boolean help;
    @Option(names = { "--version", "-v" }, versionHelp = true, hidden = true)
    boolean version;
    ...
    @Command(name = "config", description = "Update the server configuration", mixinStandardHelpOptions = true)
    ...
    @Command(name = "start", description = "Start the server", mixinStandardHelpOptions = true)
    public void start(
