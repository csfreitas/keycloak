...
public class ConfigurationTest {
    ...
    public void testCamelCase() {
        putEnvVar("KC_CAMEL_CASE_SCOPE_CAMEL_CASE_PROP", "foobar");
        initConfig();
    ...
    public void testSysPropPriorityOverEnvVar() {
        putEnvVar("KC_HOSTNAME_DEFAULT_FRONTEND_URL", "http://envvar.com");
        System.setProperty("kc.hostname.default.frontend-url", "http://propvar.com");
    ...
    public void testCLIPriorityOverSysVar() {
        ...
        System.setProperty("kc.config.args", "--hostname-frontend-url=http://cli.com");
        assertEquals("http://cli.com", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));
    }
    ...
    public void testCommandLineArguments() {
        System.setProperty("kc.config.args", "--hostname-default-frontend-url=http://fromargs.com,--no-ssl");
    ...
    public void testSpiConfigurationUsingCommandLineArguments() {
        // test spi property alias, which maps automatically to the default provider
        System.setProperty("kc.config.args", "--hostname-frontend-url=http://defaultprovider.com");
        assertNotEquals("http://defaultprovider.com", initConfig("hostname", "default").get("frontendUrl"));
        assertNotEquals("http://defaultprovider.com", initConfig("hostname", "default").defaultProvider("some").get("frontendUrl"));
        assertEquals("http://defaultprovider.com", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));

        System.setProperty("kc.config.args", "--spi-hostname-frontend-url=http://spi.com");
        assertEquals("http://spi.com", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));

        System.setProperty("kc.config.args", "--spi-hostname-default-frontend-url=http://spifull.com");
        assertEquals("http://spifull.com", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));

        // preference over the more complete property representation
        System.setProperty("kc.config.args", "--spi-hostname-frontend-url=1,--spi-hostname-default-frontend-url=2");
        assertEquals("2", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));
        System.setProperty("kc.config.args", "--hostname-frontend-url=1,--spi-hostname-default-frontend-url=2");
        assertEquals("2", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));
        System.setProperty("kc.config.args", "--hostname-frontend-url=1,--spi-hostname-frontend-url=2");
        assertEquals("2", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));
        
        // test multi-word SPI names using camel cases
        System.setProperty("kc.config.args", "--action-token-handler-verify-email-some-property=test");
        ...
        System.setProperty("kc.config.args", "--client-registration-openid-connect-static-jwk-url=http://c.jwk.url");
    ...
    public void testSpiConfigurationUsingProperties() {
        // test spi property alias, which maps automatically to the default provider
        System.setProperty("kc.hostname.frontend-url", "http://defaultprovider.com");
        assertNotEquals("http://defaultprovider.com", initConfig("hostname", "default").get("frontendUrl"));
        assertNotEquals("http://defaultprovider.com", initConfig("hostname", "default").defaultProvider("some").get("frontendUrl"));
        assertEquals("http://defaultprovider.com", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));

        System.setProperty("kc.spi.hostname.frontend-url", "http://spi.com");
        assertEquals("http://spi.com", initConfig("hostname", "default").defaultProvider("default").get("frontendUrl"));
    ...
    public void testPropertyMapping() {
        System.setProperty("kc.config.args", "--database=mariadb,--database-url=jdbc:mariadb://localhost/keycloak");
    ...
    public void testDatabaseDefaults() {
        System.setProperty("kc.config.args", "--database=h2-file");
        SmallRyeConfig config = createConfig();
        ...
        System.setProperty("kc.config.args", "--database=h2-mem");
        config = createConfig();
        assertEquals(QuarkusH2Dialect.class.getName(), config.getConfigValue("quarkus.hibernate-orm.dialect").getValue());
    ...
    public void testDatabaseProperties() {
        System.setProperty("kc.config.args", "--database=h2-file,--database-url-path=test,--database-url-properties=;;test=test;test1=test1");
        SmallRyeConfig config = createConfig();
        assertEquals(QuarkusH2Dialect.class.getName(), config.getConfigValue("quarkus.hibernate-orm.dialect").getValue());
        ...
        System.setProperty("kc.config.args", "--database=mariadb,--database-url-path=test,--database-url-properties=?test=test&test1=test1");
        config = createConfig();
