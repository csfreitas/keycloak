...
final class SecureServerDefinition extends AbstractAdapterConfigurationDefinition {
    ...
    static final String TAG_NAME = "secure-server";
    ...
    SecureServerDefinition(String tagName) {
        super(tagName, ALL_ATTRIBUTES, new SecureServerDefinition.SecureServerAddHandler(), new SecureServerDefinition.SecureServerRemoveHandler(), new SecureServerDefinition.SecureServerWriteHandler());
    }
    ...
    static final class SecureServerAddHandler extends AbstractAdapterConfigurationAddHandler {
        ...
        static void installCapability(OperationContext context, ModelNode operation) {
            ...
            serviceTarget.addService(serviceName.append("http-management-context"), createHttpManagementConfigContextService(factoryName, injectedValue)).addDependency(context.getCapabilityServiceName(HTTP_MANAGEMENT_HTTP_EXTENSIBLE_CAPABILITY, ExtensibleHttpManagement.class), ExtensibleHttpManagement.class, injectedValue).setInitialMode(Mode.ACTIVE).install();
    ...
    private static Service<Void> createHttpManagementConfigContextService(final String factoryName, final InjectedValue<ExtensibleHttpManagement> httpConfigContext) {
        return new Service<Void>() {
            public void start(StartContext startContext) throws StartException {
                ...
                extensibleHttpManagement.addStaticContext("/keycloak/adapter/" + factoryName + "/", new ResourceManager() {
            ...
            public void stop(StopContext stopContext) {
                ((ExtensibleHttpManagement)httpConfigContext.getValue()).removeContext("/keycloak");
            }
