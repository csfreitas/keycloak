    ...
    protected OAuthRequestAuthenticator createOAuthAuthenticator() {
        return new OAuthRequestAuthenticator(this, facade, deployment, sslRedirectPort, tokenStore) {
            ...
            protected String getStateCode() {
                String redirectUri = getElytronHttpFacade().getRequest().getQueryParamValue("redirect_uri");

                if (redirectUri != null) {
                    return super.getStateCode() + "$#" + redirectUri;
                }
            ...
            public String getStrippedOauthParametersRequestUri() {
                String redirectUri = getElytronHttpFacade().getRequest().getQueryParamValue("state");

                if (redirectUri != null && redirectUri.indexOf("$#") != -1) {
                    return redirectUri.substring(redirectUri.indexOf("$#") + 2);
                }

                return super.getStrippedOauthParametersRequestUri();
            }
        };
    }
