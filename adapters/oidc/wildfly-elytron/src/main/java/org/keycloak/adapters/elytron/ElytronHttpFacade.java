...
class ElytronHttpFacade implements HttpFacade {
    ...
    public ElytronHttpFacade(HttpServerRequest request) {
        ...
        this.responseConsumer = new Consumer<HttpServerResponse>() {
            @Override
    ...
    public void authenticationFailed(AuthChallenge challenge) {
        this.request.authenticationFailed("Authentication Failed", new HttpServerMechanismsResponder() {
            @Override
    ...
    public void authenticationInProgress(AuthChallenge challenge) {
        ...
        this.request.authenticationInProgress(new HttpServerMechanismsResponder() {
            @Override
            public void sendResponse(HttpServerResponse response) {
                responseConsumer.accept(response);
            }
