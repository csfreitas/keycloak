...
public class ElytronSamlAuthenticator extends SamlAuthenticator {
    ...
    public ElytronSamlAuthenticator(ElytronHttpFacade facade, SamlDeployment samlDeployment, SamlSessionStore sessionStore, CallbackHandler callbackHandler) {
        super(facade, samlDeployment, sessionStore);
