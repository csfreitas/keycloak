...
import org.keycloak.validate.StringFormatValidatorBase;
 ...
 * values handling and collections support see {@link StringFormatValidatorBase}. Validator trims String value before
 * the length validation, can be disabled by {@link #KEY_TRIM_DISABLED} boolean configuration entry set to
 * <code>true</code>.
 * <p>
 * Configuration have to be always provided, with at least one of {@link #KEY_MIN} and {@link #KEY_MAX}.
 */
public class LengthValidator extends StringFormatValidatorBase {
	...
	@Override
	protected boolean validateFormat(String value, String inputHint, ValidationContext context, ValidatorConfig config) {
