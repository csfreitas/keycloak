...
public class ValidatorConfigValidator implements SimpleValidator {
	...
	/**
	 * Generic error messages for config validations - invalid config value - integer number expected
	 */
	public static final String MESSAGE_CONFIG_INVALID_INTEGER_VALUE = "error-validator-config-invalid-integer-value";
