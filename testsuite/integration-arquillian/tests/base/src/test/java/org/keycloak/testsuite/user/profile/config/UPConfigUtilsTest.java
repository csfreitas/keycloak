...
public class UPConfigUtilsTest {
    ...
    public void isRoleForContext() {
        ...
        roles.add(UPConfigParser.ROLE_ADMIN);
        ...
        roles = new ArrayList<>();
        roles.add(UPConfigParser.ROLE_USER);
    ...
    public void breakString() {
        List<String> ret = UPConfigUtils.breakString(null, 2);
        Assert.assertEquals(0, ret.size());

        ret = UPConfigUtils.breakString("", 2);
        assertListContent(ret, "");

        ret = UPConfigUtils.breakString("1234567", 3);
        assertListContent(ret, "123", "456", "7");

        ret = UPConfigUtils.breakString("12345678", 3);
        assertListContent(ret, "123", "456", "78");

        ret = UPConfigUtils.breakString("123456789", 3);
