...
/**
 * <p>A {@link RealmAdminResourceProvider} is responsible to resolve a given path to a JAX-RS resource object. It serves as an
 * extension point in order to plug additional RESTful endpoints (eg.: additional API) to Keycloak Administration API and extend its capabilities.</p>
 *
