...
public class DeviceGrantType {
    ...
    public DeviceGrantType(MultivaluedMap<String, String> formParams, ClientModel client, TokenEndpoint tokenEndpoint,
        KeycloakSession session, HttpRequest request, TokenManager tokenManager, RealmModel realm, EventBuilder event,
        Cors cors) {
    ...
    public Response oauth2DeviceFlow() {
        ...
        tokenEndpoint.updateClientSession(clientSession);
        tokenEndpoint.updateUserSessionFromClientAuth(userSession);
